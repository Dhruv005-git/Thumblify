            ...
            {thumbnails.map((thumb: IThumbnail) => {
              ...
              return (
                <div
                  ...
                  className="group relative cursor-pointer rounded-2xl bg-white/6 border border-white/10 shadow-xl overflow-hidden hover:border-pink-500 transition"
                >
                  {/* Thumbnail Image */}
                  <div
                    className={`relative w-full overflow-hidden ${aspectClass} bg-black`}
                  >
                    {thumb.image_url ? (
                      <img
                        src={thumb.image_url}
                  ...
                  >
                    <TrashIcon
                      ...
                      className="size-7 bg-black/60 p-1.5 rounded-lg hover:bg-pink-600 transition"
                    />
                    ...
                    <Link
                      ...
                      target="_blank"
                    >
                      <ArrowUpRightIcon className="size-7 bg-black/60 p-1.5 rounded-lg hover:bg-pink-600 transition" />
                    </Link>
                  </div>
                </div>
              );
