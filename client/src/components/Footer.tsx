...
import { Code2Icon, GithubIcon, LaptopIcon, LinkedinIcon } from "lucide-react";
    ...
    return (
        <footer className="flex flex-wrap justify-center md:justify-between overflow-hidden gap-10 md:gap-20 mt-40 py-6 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500">
            ...
            <motion.div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end"
                ...
                transition={{ type: "spring", stiffness: 280, damping: 70, mass: 1 }}
            >
                <p className="max-w-60">Helping creators get more clicks with smarter thumbnails.</p>
                <div className="flex items-center gap-4 mt-3">
                    <a href="https://github.com/Dhruv005-git" target="_blank" rel="noreferrer">
                        <GithubIcon className="size-5 hover:text-pink-500" />
                    </a>
                    <a href="https://www.linkedin.com/in/dhruv-jain-a958772a6/" target="_blank" rel="noreferrer">
                        <LinkedinIcon className="size-5 hover:text-pink-500" />
                    </a>
                    <a href="https://leetcode.com/u/DhruvJain13/" target="_blank" rel="noreferrer">
                        <Code2Icon className="size-5 hover:text-pink-500" />
                    </a>
                    <a href="https://codeforces.com/profile/O1Dhruv" target="_blank" rel="noreferrer">
                        <LaptopIcon className="size-6 hover:text-pink-500" />
                    </a>
                </div>
                <p className="mt-3 text-center">&copy; {new Date().getFullYear()} Thumblify - Dhruv Jain</p>
            </motion.div>
        </footer>
    );
}