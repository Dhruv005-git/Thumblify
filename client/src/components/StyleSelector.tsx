...
const StyleSelector = ({value, onChange, isOpen, setIsOpen} : {value: ThumbnailStyle; onChange: (style: ThumbnailStyle)=>void; isOpen: boolean; setIsOpen: (open: boolean)=>void}) => {
    ...
    "Minimalist": "Clean lines, simple shapes, and a focus on essential elements.",
    "Photorealistic": "High-detail images that look like real photographs.",
    "Illustrated": "Hand-drawn or digitally illustrated styles with artistic flair.",
